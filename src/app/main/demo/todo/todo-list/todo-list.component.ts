...
import { Todo } from 'app/main/demo/todo/todo.model';
        ...
        this._todoService.onCurrentTodoChanged
            ...
            .subscribe(currentTodo => {
                if ( !currentTodo )
                {
                    ...
                    if ( tagHandle )
                    {
                        this._location.go('demo/todo/tag/' + tagHandle);
                    }
                    else if ( filterHandle )
                    {
                        this._location.go('demo/todo/filter/' + filterHandle);
                    }
                    else
                    {
                        this._location.go('demo/todo/all');
                    }
                }
                else
                {
