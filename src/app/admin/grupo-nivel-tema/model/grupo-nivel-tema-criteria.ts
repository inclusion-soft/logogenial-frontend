import { GrupoNivelTemaModel } from "./grupo-nivel-tema-model";
import { MatPaginator, MatSort } from '@angular/material';

export class GrupoNivelTemaCriteria extends GrupoNivelTemaModel  {
  ...
  public getUrlParameters(): string {
    return 'grupoNivelId=' + this.grupoNivel.id +
